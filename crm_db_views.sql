...
SELECT DISTINCT ps.id, ps.product_service_group_id, ps.server_id, ps.product_service_module_id, ps.product_service_type_id, ps.product_name, ps.product_desc, ps.is_hidden,
ps.cp_package, ps.status, ps.updated_on,
...
JOIN server_modules psm on ps.product_service_module_id=psm.id
