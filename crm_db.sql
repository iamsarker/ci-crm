...
(20, 'reseller_price_lifted', 'Reseller - Selling Price Auto-Adjusted', 'Your selling price for {item_name} was adjusted', '<p>Dear {reseller_name},</p><p>Our cost for <strong>{item_name}</strong> has increased, and your selling price was below the new cost. To make sure you are never selling at a loss, it has been raised to the minimum allowed:</p>{price_changes}<p>This is the floor, not a recommendation &mdash; you can set a higher price at any time from your portal.</p><p>Regards,<br>{site_name}</p>', '{reseller_name}, {item_name}, {price_changes}, {site_name}, {company_name}, {site_url}', 'GENERAL', 0, '2026-09-03 10:00:00', NULL, '2026-09-03 10:00:00', NULL, NULL, NULL),
...
(9, 'PayHere', 'payhere', 'online_card', NULL, 'ONLINE', '', '', '', 1, '', '', NULL, NULL, '', '', '', '', '', '', 'LKR,USD,GBP,EUR,AUD', 1.00, 0.00, 'none', 0.00, 0.00, 'merchant', NULL, 'PayHere', 'Pay with Visa, Mastercard, or mobile wallets via PayHere.', 7, '', '', NULL, '', 0, '2026-07-04 00:00:00', NULL, NULL, NULL),
(10, 'Paddle', 'paddle', 'online_card', NULL, 'ONLINE', '', '', '', 1, '', '', '', NULL, '', '', '', '', '', '', 'USD,EUR,GBP,AUD,CAD,CHF,SGD,INR,JPY', 1.00, 0.00, 'none', 0.00, 0.00, 'merchant', NULL, 'Paddle', 'Pay securely by card via Paddle.', 8, '', '', NULL, '', 0, '2026-07-04 00:00:00', NULL, NULL, NULL);
...
(57, 'reseller_default_discount_type', 'percent', 'RESELLER', '2026-09-08 00:00:00', '2026-09-08 00:00:00'),
(58, 'reseller_default_discount_value', '0.00', 'RESELLER', '2026-09-08 00:00:00', '2026-09-08 00:00:00');
