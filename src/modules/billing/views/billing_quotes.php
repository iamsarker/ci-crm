        ...
        <div class="col-md-9 col-sm-12">
			...
			<nav aria-label="breadcrumb">
				<ol class="breadcrumb breadcrumb-style1 mg-b-0">
					...
					<li class="breadcrumb-item active"><a>My Quotes</a></li>
				</ol>
			</nav>
                          ...
                          <td>
							  <div class="btn-group">
								  ...
								  <div class="dropdown-menu">
									  <a class="dropdown-item" style="cursor: pointer;" onclick="viewInvoiceDetail('<?=$row['invoice_uuid']?>')"><i class="fa fa-eye text-info"></i> View</a>
									  <a class="dropdown-item" style="cursor: pointer;" onclick="downloadInvoiceDetail('<?=$row['invoice_uuid']?>')"><i class="fa fa-file-pdf text-danger"></i> Download</a>
									  <?php if( $row['pay_status'] != "PAID" ){ ?>
										  <div class="dropdown-divider"></div>
										  <a class="dropdown-item" style="cursor: pointer;"><i class="fa fa-money-bill-alt text-success"></i> Pay now</a>
									  <?php } ?>
								  </div>
							  </div>
						  </td>
