        ...
        <div class="col-md-9 col-sm-12">
			...
			<nav aria-label="breadcrumb">
				<ol class="breadcrumb breadcrumb-style1 mg-b-0">
					...
					<li class="breadcrumb-item active"><a href="<?=base_url()?>supports/KB">Knowledge Bases</a></li>
					<li class="breadcrumb-item active"><a href="<?=base_url()?>supports/view_kb/<?=$details['id']?>/<?=$details['slug']?>"><?=$details['title']?></a></li>
				</ol>
			</nav>
