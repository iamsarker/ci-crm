                    ...
                    <ul class="list-group list-group-flush">
                        <?php if(!empty($archive)) { ?>
                            ...
                            <li class="list-group-item d-flex justify-content-between align-items-center <?=$isActive ? 'active' : ''?>">
                                <a href="<?=base_url()?>supports/announcements_archive/<?=$item['year']?>/<?=$item['month']?>" class="<?=$isActive ? 'text-white' : ''?>">
                                    <i class="fa fa-folder-open mg-r-5 <?=$isActive ? '' : 'text-muted'?>"></i><?=$item['month_name']?>
                                </a>
                                <span class="badge rounded-pill <?=$isActive ? 'bg-white text-primary' : 'bg-primary'?>"><?=$item['total']?></span>
                            </li>
                            <?php } ?>
                        <?php } else { ?>
            ...
            <div class="col-md-9 col-sm-12">
                ...
                <div class="page-header-card page-header-kb">
                    <div class="d-flex justify-content-between align-items-center flex-wrap">
                        <div>
                            <h3><i class="fa fa-bullhorn mg-r-10"></i><?=$month_name?></h3>
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb breadcrumb-style1 mg-b-0">
                                    ...
                                    <li class="breadcrumb-item active"><a><?=$month_name?></a></li>
                                </ol>
                            </nav>
                        </div>
                        <div class="header-actions mt-2 mt-md-0">
                            <a href="<?=base_url()?>supports/announcements" class="btn btn-light btn-sm">
                                <i class="fa fa-arrow-left mg-r-5"></i>All Announcements
                            </a>
                        </div>
                    </div>
                </div>
                ...
                <div class="d-flex justify-content-between align-items-center mg-b-15">
                    <h5 class="mg-b-0 tx-semibold"><i class="fa fa-bullhorn text-primary mg-r-10"></i>Announcements</h5>
                    ...
                    <ul class="list-group list-group-flush" id="announcement-list">
                        ...
                        <li class="list-group-item">
                            <div class="empty-state">
                                ...
                                <p>No announcements for this period</p>
                            </div>
                        </li>
                        <?php } ?>
                    </ul>
