      ...
      <div class="container pd-x-0 pd-lg-x-12 pd-xl-x-0">
        ...
        <div class="row mt-5">
			<div class="col-md-12 col-sm-12">
				<h3 class="d-flex justify-content-between"><span>Service Groups</span> <a href="<?=base_url()?>whmazadmin/service_group/manage" class="btn btn-sm btn-secondary"><i class="fa fa-plus-square"></i>&nbsp;Add</a></h3>
				<hr class="mg-5" />
				<nav aria-label="breadcrumb">
					<ol class="breadcrumb breadcrumb-style1 mg-b-0">
						<li class="breadcrumb-item"><a href="<?=base_url()?>whmazadmin/dashboard/index">Portal home</a></li>
						<li class="breadcrumb-item active"><a href="#">Service groups</a></li>
					</ol>
				</nav>
			...
			<div class="col-md-12 col-sm-12 mt-5">
				<table id="listDataTable" class="table table-hover">
					...
					<tr>
						...
						<th class="wd-25p">Group headline</th>
					...
					<?php foreach($results as $row){ ?>
						<tr>
							...
							<td><?php echo $row['group_headline']; ?></td>
							...
							<td class="text-center">
								...
								<button type="button" class="btn btn-xs btn-danger" onclick="deleteRow('<?=safe_encode($row['id'])?>', <?= json_encode($row['group_name'] ?? '') ?>)" title="Delete"><i class="fa fa-trash"></i></button>
							</td>
						</tr>
					<?php } ?>
					</tbody>
