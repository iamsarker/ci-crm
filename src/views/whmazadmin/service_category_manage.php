			...
			<div class="col-12">
				<div class="company-page-header">
					<div class="d-flex justify-content-between align-items-start flex-wrap gap-3">
						<div>
							<h3><i class="fa fa-layer-group"></i> <?= !empty($detail['servce_type_name']) ? htmlspecialchars($detail['servce_type_name']) : 'New Service Category' ?></h3>
						...
						<a href="<?=base_url()?>whmazadmin/service_category/index" class="btn btn-back">
		...
		<div class="row mt-4">
			<div class="col-12">
				<div class="manage-form-card">
					<form method="post" name="entityManageForm" id="entityManageForm" class="company-form" action="<?=base_url()?>whmazadmin/service_category/manage/<?= safe_encode(!empty($detail['id']) ? $detail['id'] : 0)?>">
						<?=csrf_field()?>
							...
							<div class="row">
								<div class="col-md-8">
									<div class="form-group">
										<label class="form-label" for="servce_type_name"><i class="fa fa-tag"></i> Category Name</label>
										<input name="servce_type_name" type="text" class="form-control" id="servce_type_name" placeholder="Enter category name" value="<?= htmlspecialchars($detail['servce_type_name'] ?? '', ENT_QUOTES, 'UTF-8') ?>"/>
