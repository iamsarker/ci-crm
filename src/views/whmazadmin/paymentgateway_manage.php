                ...
                <div class="card-header d-flex justify-content-between align-items-center">
                    <div>
                        <h4 class="card-title mb-0">
                            <i class="fas fa-cog"></i> Configure <?php echo htmlspecialchars($gateway['name'] ?? ''); ?>
                        </h4>
                        <small class="text-muted">Gateway Code: <?php echo $gateway['gateway_code']; ?></small>
                    </div>
                    <a href="<?php echo base_url(); ?>whmazadmin/paymentgateway" class="btn btn-secondary">
                    ...
                    <form id="gateway-form" method="post">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="card mb-4">
                                    <div class="card-header bg-light">
                                        <h5 class="mb-0"><i class="fas fa-info-circle"></i> Basic Settings</h5>
                                    </div>
                                    <div class="card-body">
                                        <div class="mb-3">
                                ...
                                <div class="card mb-4">
                                    <div class="card-header bg-light">
                                        <h5 class="mb-0"><i class="fas fa-university"></i> Bank Account Details</h5>
                                    </div>
                                    <div class="card-body">
                                        <div class="mb-3">
                                ...
                                <div class="card mb-4">
                                    <div class="card-header bg-light">
                                        <h5 class="mb-0"><i class="fas fa-align-left"></i> Payment Instructions</h5>
                                    </div>
                                    <div class="card-body">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="card mb-4">
                                    <div class="card-header bg-light">
                                        <h5 class="mb-0"><i class="fas fa-coins"></i> Currency & Limits</h5>
                                    </div>
                                    <div class="card-body">
                                        <div class="mb-3">
                                ...
                                <div class="card mb-4">
                                    <div class="card-header bg-light">
                                        <h5 class="mb-0"><i class="fas fa-percentage"></i> Processing Fees</h5>
                                    </div>
                                    <div class="card-body">
                                        <div class="mb-3">
                                ...
                                <div class="card mb-4">
                                    <div class="card-header bg-light">
                                        <h5 class="mb-0"><i class="fas fa-sliders-h"></i> Additional Configuration</h5>
                                    </div>
                                    <div class="card-body">
                                        <div class="mb-3">
