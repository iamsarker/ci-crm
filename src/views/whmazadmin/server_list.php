      ...
      <div class="container pd-x-0 pd-lg-x-12 pd-xl-x-0">
        ...
        <div class="row mt-5">
			<div class="col-md-12 col-sm-12">
				<h3 class="d-flex justify-content-between"><span>Servers</span> <a href="<?=base_url()?>whmazadmin/server/manage" class="btn btn-sm btn-secondary"><i class="fa fa-plus-square"></i>&nbsp;Add</a></h3>
				<hr class="mg-5" />
				<nav aria-label="breadcrumb">
					<ol class="breadcrumb breadcrumb-style1 mg-b-0">
						<li class="breadcrumb-item"><a href="<?=base_url()?>whmazadmin/dashboard/index">Portal home</a></li>
						<li class="breadcrumb-item active"><a href="#">Servers</a></li>
					</ol>
				</nav>
			...
			<div class="col-md-12 col-sm-12 mt-5">
				<table id="listDataTable" class="table table-hover">
					<thead>
					<tr>
						<th class="wd-20p">Server name</th>
						<th class="wd-10p text-center">IP Address</th>
						<th class="wd-15p text-center">Hostname</th>
						<th class="wd-10p">Dns1</th>
						<th class="wd-10p">Dns2</th>
						<th class="wd-10p">Dns3</th>
						<th class="wd-10p">Dns4</th>
