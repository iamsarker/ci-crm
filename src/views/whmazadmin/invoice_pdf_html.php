			...
			<tr>
				...
				<td colspan="2" style="text-align: right;">
					...
					<h5 style="text-align: right; width: 100%;">
						<?php
						echo !empty($companyInfo['CompanyAddress']->cnf_val) ? htmlspecialchars($companyInfo['CompanyAddress']->cnf_val, ENT_QUOTES, 'UTF-8') : "";
			...
			<tr>
				<td colspan="4">
					...
					<span style="width: 100%;">
						<?php
						echo !empty($invoice['company_address']) ? htmlspecialchars($invoice['company_address'], ENT_QUOTES, 'UTF-8') : "";
					...
					<span style="width: 100%;">
						<?php
						echo !empty($invoice['country']) ? htmlspecialchars($invoice['country'], ENT_QUOTES, 'UTF-8') : "";
						?>
					</span>
				</td>
			</tr>
