<div class="card card-widget card-contacts mt-3">
  ...
  <ul class="list-group list-group-flush">
    <li class="list-group-item">
      <a title="Send EPP Code" href="<?=base_url()?>clientarea/webmail_single_sign_on/<?= !empty($detail['order_id']) ? $detail['order_id'] : '0'?>/<?= !empty($detail['id']) ?  $detail['id']: '0'?>" target="_blank" class="nav-sub-link"><i data-feather="mail"></i>&nbsp;Send EPP Code</a>
    </li>
    <li class="list-group-item">
