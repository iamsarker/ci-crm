...
<html lang="en">
  <head>
    ...
    <meta name="twitter:description" content="WHMAZ - Web Host Manager A to Z solutions. Alternative of WHMCS">
    <meta name="twitter:image" content="http://themepixels.me/dashforge/img/dashforge-social.png">

    <!-- Facebook -->
    <meta property="og:url" content="https://whmaz.com/">
    <meta property="og:title" content="WHMAZ">
    <meta property="og:description" content="WHMAZ - Web Host Manager A to Z solutions. Alternative of WHMCS">
    ...
    <!-- Meta -->
    <meta name="description" content="WHMAZ - Web Host Manager A to Z solutions. Alternative of WHMCS">
  ...
  <body class="page-profile">
      ...
      <div class="navbar-brand">
        ...
        <ul class="nav navbar-menu">
          ...
          <li class="nav-item"><a href="<?=base_url()?>knowledgebase" class="nav-link"><i data-feather="archive"></i> Knowledgebase</a></li>
          <li class="nav-item"><a href="<?=base_url()?>contactus" class="nav-link"><i data-feather="archive"></i> Contact us</a></li>
          <?php }?>
